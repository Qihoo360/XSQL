...
case class CatalogTable(
  ...
  def dataSource: Option[String] = identifier.dataSource
...
object CatalogTableType {
  val JDBC = new CatalogTableType("JDBC")
  val REDIS = new CatalogTableType("REDIS")
  val HBASE = new CatalogTableType("HBASE")
  val EXTERNAL = new CatalogTableType("EXTERNAL")
  val MANAGED = new CatalogTableType("MANAGED")
  val VIEW = new CatalogTableType("VIEW")
  val TYPE = new CatalogTableType("TYPE")
  val COLLECTION = new CatalogTableType("COLLECTION")
  val DATASOURCE = new CatalogTableType("DATASOURCE")
  val TOPIC = new CatalogTableType("TOPIC")
}
